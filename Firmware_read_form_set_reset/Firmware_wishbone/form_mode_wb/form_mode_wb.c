...
// ************************************************
//          *** Hardware Test Case for Forming ***
...
void main(void)
{
    ...
    print("[FORM_MODE_WB] Wishbone enabled\n");

    // -----------------------------
    // Performing FORM mode write sequence
    // Converted from your cocotb firmware
    // -----------------------------

    print("[FORM_MODE_WB] Writing command 1: 0x00036472\n");
    REG32(NEURO_ADDR) = 0x00036472;
    wait_cycles(500);

    print("[FORM_MODE_WB] Writing command 2: 0x462B000B\n");
    REG32(NEURO_ADDR) = 0x462B000B;
    wait_cycles(500);

    print("[FORM_MODE_WB] Writing command 3: 0x84001405\n");
    REG32(NEURO_ADDR) = 0x84001405;
    wait_cycles(500);

    print("[FORM_MODE_WB] Writing command 4: 0x8003AAFF\n");
    REG32(NEURO_ADDR) = 0x8003AAFF;
    wait_cycles(500);

    print("[FORM_MODE_WB] Writing command 5: 0x4003AAFF\n");
    ...
    // -----------------------------
    print("[FORM_MODE_WB] Reading back from 0x30000004\n");

    temp = read_wishbone(NEURO_ADDR);

    print("[FORM_MODE_WB] Readback value = ");
    ...
    print("[FORM_MODE_WB] test finished\n");
